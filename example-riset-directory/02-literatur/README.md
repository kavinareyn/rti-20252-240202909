...
Klasifikasi penyakit daun tanaman menggunakan citra digital.
Tomato Diseases Dataset (Kaggle).
Digital Image Processing dan Computer Vision.
TensorFlow dan Keras.
Evaluasi model menggunakan Accuracy, Precision, Recall, F1-Score, dan Confusion Matrix.
---
Jurnal Acuan

Penelitian ini menggunakan beberapa jurnal utama sebagai dasar implementasi metode CNN dan Grad-CAM.
| Penulis                    | Tahun | Keterangan                                                                            |
| -------------------------- | :---: | ------------------------------------------------------------------------------------- |
| Mohanty, Hughes, & Salathé |  2016 | Penerapan Deep Learning untuk klasifikasi penyakit tanaman menggunakan citra digital. |
| Ferentinos                 |  2018 | Implementasi CNN pada klasifikasi penyakit tanaman dengan akurasi tinggi.             |
...
Analisis hasil eksperimen berdasarkan Accuracy, Precision, Recall, F1-Score, Confusion Matrix, dan visualisasi Grad-CAM.
Penyusunan pembahasan serta penarikan kesimpulan penelitian.
---
